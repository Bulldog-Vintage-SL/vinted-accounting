            ...
            <DialogContent className="!max-w-[520px] w-full p-0 rounded-2xl overflow-hidden">
                ...
                <div className="p-6 flex flex-col gap-4">
                    ...
                    {!isSupported && platform && (
                        <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex gap-3">
                            ...
                            <p className="text-sm text-red-800 leading-relaxed">
                                La resubida todavía no está disponible para <span className="font-semibold">{platformLabel}</span>.
                            </p>
                        </div>
                    )}
                            ...
                            <div className="flex-1 min-w-0">
                                <p className={`text-sm leading-relaxed ${isSynced ? 'text-green-800' : 'text-yellow-800'}`}>
                                    {loadingAccount
                                        ...
                                        : isSynced
                                            ? 'Cuenta sincronizada. Ya puedes resubir la publicación.'
                                            : 'Debes sincronizar la cuenta antes de poder resubir esta publicación.'}
                                </p>
                    ...
                    <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 flex gap-3">
                        <RefreshCw size={18} className="text-emerald-500 mt-0.5 shrink-0" />
                        <p className="text-sm text-emerald-800 leading-relaxed">
                            <span className="font-semibold">Se volverá a publicar el anuncio</span>{" "}
                            en <span className="font-semibold">{platformLabel}</span> con los datos actuales del producto.
                        </p>
                    </div>
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-3">
                        ...
                        <p className="text-sm text-amber-800 leading-relaxed">
                            Si ya existía una publicación activa en {platformLabel}, revisa que no queden anuncios duplicados.
                        </p>
                    </div>
                </div>
